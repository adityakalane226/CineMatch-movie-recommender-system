...
def load_data():
    download_if_missing(
        "similarity.pkl",
        "https://huggingface.co/datasets/adityakalane/similarity.pkl/resolve/main/similarity.pkl"
    )
    download_if_missing(
        "movie_dict.pkl",
        "https://huggingface.co/datasets/adityakalane/similarity.pkl/resolve/main/movie_dict.pkl"
    )
